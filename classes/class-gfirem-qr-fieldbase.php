...
if ( ! class_exists( 'GFireMQrFieldBase' ) ) {

    class GFireMQrFieldBase {
        ...
        public function show_formidable_field_admin_field( $field ) {
            ...
            $description = ( ! empty( $this->description ) ) ? $this->description : __( 'Default placeholder to show into the admin.', 'gfirem_qr-locale' );
        ...
        protected function inside_field_options( $field, $display, $values ) {
            ...
            <tr>
                <td>
                    <label for="field_options[field_option_name_<?php echo esc_attr( $field['id'] ) ?>]"><?php _e( 'Example option', 'gfirem_qr-locale' ) ?></label>
                    <span class="frm_help frm_icon_font frm_tooltip_icon" title="" data-original-title="<?php _e( 'This is a formidable tooltip example', 'gfirem_qr-locale' ) ?>"></span>
                </td>
                <td>

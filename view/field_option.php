...
?>
<tr>
    <td><label for="size_<?php echo esc_attr( $field['id'] ) ?>"><?php _e( "Size","gfirem_date_time-locale" ) ?></label></td>
    <td>
        <label for="size_<?php echo esc_attr( $field['id'] ) ?>" class="howto"><?php echo esc_attr( _e( "Size for QR Code, by default is '1'. " ,"gfirem_qr_time-locale") ) ?></label>
...
<tr>
    <td><label for="ECC_<?php echo esc_attr( $field['id'] ) ?>"><?php _e( "ECC","gfirem_date_time-locale" ) ?></label></td>
    <td>
        <label for="ECC_<?php echo esc_attr( $field['id'] ) ?>" class="howto"><?php echo esc_attr( _e( "Error Correction Capability, by default is 'Level L (7%)'. " ,"gfirem_qr_time-locale") ) ?></label>
